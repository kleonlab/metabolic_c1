sbatch slurm/at-rtx.sbatch uv run state tx train \
  ...
  data.kwargs.perturbation_features_file=null \
...
sbatch slurm/at-rtx.sbatch uv run state tx train \
  ...
  use_wandb=true \
  wandb.tags="[st-tahoe-pretrain]" \
  wandb.project=state-arc \
  wandb.entity=a-mete-2416 \
  output_dir="experiments/" \
  name="st-tahoe-pretrain"
...
sbatch slurm/at-rtx.sbatch uv run state tx train \
  ...
  model=st-tahoe \
  use_wandb=true \
  wandb.tags="[st-tahoe-pertfeat]" \
  wandb.project=state-arc \
  wandb.entity=a-mete-2416 \
  output_dir="experiments/" \
  name="st-tahoe-pertfeat"